    ...
    <>
      ...
      <section className='tw-bg-[#F4f4f4]'>
        ...
        <Card className='tw-mx-[7rem] tw-mt-10 tw-rounded-sm tw-bg-white tw-px-10  tw-py-5'>
          <div className='tw-mt-3 tw-flex  tw-justify-between tw-gap-[30%] tw-font-extrabold'>
            <div className='tw-flex tw-flex-col'>
              <span className='tw-text-3xl tw-uppercase'>Company list</span>{' '}
            ...
            {!sesamiToSapLoading && (
              <TableContainer component={Paper} className='!tw-rounded-2xl'>
                <Table sx={{ minWidth: 700 }} aria-label='customized table'>
                  ...
                  <TableBody className=' !tw-text-black'>
                    {sesamiToSapDataSearched.slice(0, 5).map((row: any) => (
        ...
        <Card className='tw-mx-[7rem] tw-mt-10 tw-rounded-sm tw-bg-white tw-px-10  tw-py-5'>
          <div className='tw-mt-3 tw-flex  tw-justify-between tw-gap-[30%] tw-font-extrabold'>
            <div className='tw-flex tw-flex-col'>
              <span className='tw-text-3xl'>Payroll LIST</span>{' '}
              <span className='tw-mt-4 tw-text-gray-400'>
                ...
                <Table sx={{ minWidth: 700 }} aria-label='customized table'>
                  <TableHead>
                    <TableRow>
                      ...
                      <StyledTableCell align='center'>Dept Code</StyledTableCell>

                      <StyledTableCell align='center'>
                      Dept Name
                      </StyledTableCell>
                      <StyledTableCell align='center'>Sec Code</StyledTableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody className=' !tw-text-black'>
